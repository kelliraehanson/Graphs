...
Answer: Well, the instructor said something like if you have 10 users with an average of 2 friends each you would need to call addFriendship() 20 times. So, if you had 100 users with an average of 10 friends each that means you would need ot call addFriendship 1,000 times. But the number of users multiplied by average friends divided by 2 (two back slashes //) would make the answer 500 times.
